...
*// case when aa and bb powers are present
id F(qPow?, bPow?, pw1?, pw2?, pw3?, pw4?, pw5?, pw6?) = 
   IRCHECK(bPow+qPow-pw1-pw2-pw3-pw4-1) * F(qPow, bPow, pw1,pw2,pw3,pw4,pw5,pw6);
...
*// for overlap fermions, mainly there are additional factors of aa and bb
*// coming from the denominator that are included here as pw5, and pw6

id IRCHECK(1) * F(qPow?,bPow?,pw1?,pw2?,pw3?,pw4?,pw5?,pw6?) = 
   c(qPow,bPow,pw1,pw2,pw3,pw4,pw5,pw6)*B(0,bPow+qPow,pw1,pw2,pw3,pw4) + J(qPow,bPow,pw1,pw2,pw3,pw4,pw5,pw6);
